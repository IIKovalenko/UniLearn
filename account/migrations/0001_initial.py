...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'account_userprofile_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'account.userprofile'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(u'account_userprofile_groups', ['userprofile_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'UserProfile'
        db.create_table(u'account_userprofile_user_permissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'account.userprofile'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(u'account_userprofile_user_permissions', ['userprofile_id', 'permission_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('account_userprofile_groups')

        # Removing M2M table for field user_permissions on 'UserProfile'
        db.delete_table('account_userprofile_user_permissions')
